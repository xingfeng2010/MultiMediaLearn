...
#ifndef MULTIMEDIALEARN_EGL_CORE_H
#define MULTIMEDIALEARN_EGL_CORE_H
...
/**
 * Constructor flag: ask fro GLES3, fall back to GLES2 if not availabe. Without
 * this flag, GLES2 is used.
 */
...
#endif //MULTIMEDIALEARN_EGL_CORE_H
