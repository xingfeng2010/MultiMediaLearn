...
#include <jni.h>
/* Header for class com_player_xingfeng_multimedia_audioplay_audiotrack_MusicDecoder */

#ifndef _Included_com_player_xingfeng_multimedia_audioplay_audiotrack_MusicDecoder
#define _Included_com_player_xingfeng_multimedia_audioplay_audiotrack_MusicDecoder
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_player_xingfeng_multimedia_audioplay_audiotrack_MusicDecoder
 * Method:    getMusicMeta
