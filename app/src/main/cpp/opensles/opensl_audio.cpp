...
Java_com_player_xingfeng_multimedia_opensles_OpenslesPlay_playAudioByOpenSL_1assets(JNIEnv *env, jobject instance, jobject assetManager, jstring filename) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_player_xingfeng_multimedia_opensles_OpenslesPlay_playAudioByOpenSL_1uri(JNIEnv *env, jobject instance, jstring uri) {
    SLresult result;
    release();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_player_xingfeng_multimedia_opensles_OpenslesPlay_playAudioByOpenSL_1pcm(JNIEnv *env, jobject instance,
                                                                 jstring pamPath_) {
    release();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_player_xingfeng_multimedia_opensles_OpenslesPlay_sendPcmData(JNIEnv *env, jobject instance,
